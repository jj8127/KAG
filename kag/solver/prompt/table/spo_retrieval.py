...
class TableSpoRetrieval(PromptABC):
  ...
  "示例": [
    ...
    {
      "问题": "current_subquestion: 查找阿里巴巴2024年-截至9月30日止六个月的收入总额, current_step: 通过表查询收入那一行",
      "SPO 提及": "Table containRow TableRow",
      "SPO 候选项": [
        "阿里巴巴2024年中期简明合并利润表 containRow 阿里巴巴2024年中期简明合并利润表-收入",
        "阿里巴巴2024年中期简明合并利润表 containRow 阿里巴巴2024年中期简明合并利润表-其他净收入（支出）",
        "阿里巴巴2024年中期简明合并利润表 containRow 阿里巴巴2024年中期简明合并利润表-净利润"
      ],
      "output": [
        "阿里巴巴2024年中期简明合并利润表 containRow 阿里巴巴2024年中期简明合并利润表-收入"
      ]
